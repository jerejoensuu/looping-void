  ...
  execute if score #triggerOverworld av_cfg matches 1.. run tellraw @s [ \
    ...
    { \
      "text":"[OFF]", \
      "color":"gray", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/set_enabled_overworld {enabled:0}"}, \
      "hover_event":{"action":"show_text","value":{"text":"Disable Aether Void in the Overworld","color":"red"}} \
    } \
  ]
  ...
  execute if score #triggerOverworld av_cfg matches ..0 run tellraw @s [ \
    ...
    { \
      "text":"[ON]", \
      "color":"gray", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/set_enabled_overworld {enabled:1}"}, \
      "hover_event":{"action":"show_text","value":{"text":"Enable Aether Void in the Overworld","color":"green"}} \
    }, \
    {"text":"/","color":"gray"}, \
  ...
  execute if score #triggerNether av_cfg matches 1.. run tellraw @s [ \
    ...
    { \
      "text":"[OFF]", \
      "color":"gray", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/set_enabled_nether {enabled:0}"}, \
      "hover_event":{"action":"show_text","value":{"text":"Disable Aether Void in the Nether","color":"green"}} \
    } \
  ]
  ...
  execute if score #triggerNether av_cfg matches ..0 run tellraw @s [ \
    ...
    { \
      "text":"[ON]", \
      "color":"gray", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/set_enabled_nether {enabled:1}"}, \
      "hover_event":{"action":"show_text","value":{"text":"Enable Aether Void in the Nether","color":"red"}} \
    }, \
    {"text":"/","color":"gray"}, \
    {"text":"[OFF]","bold":true,"color":"red"} \
  ]
  ...
  execute if score #triggerEnd av_cfg matches 1.. run tellraw @s [ \
    ...
    { \
      "text":"[OFF]", \
      "color":"gray", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/set_enabled_end {enabled:0}"}, \
      "hover_event":{"action":"show_text","value":{"text":"Disable Aether Void in the End","color":"red"}} \
    } \
  ]
  ...
  execute if score #triggerEnd av_cfg matches ..0 run tellraw @s [ \
    ...
    { \
      "text":"[ON]", \
      "color":"gray", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/set_enabled_end {enabled:1}"}, \
      "hover_event":{"action":"show_text","value":{"text":"Enable Aether Void in the End","color":"green"}} \
    }, \
    {"text":"/","color":"gray"}, \
    {"text":"[OFF]","bold":true,"color":"red"} \
  ]
  ...
  execute if score #returnToLastGrounded av_cfg matches 1.. run tellraw @s [ \
    ...
    { \
      "text":"[OFF]", \
      "color":"gray", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/set_return_to_last_grounded {enabled:0}"}, \
  ...
  execute if score #returnToLastGrounded av_cfg matches ..0 run tellraw @s [ \
    ...
    { \
      "text":"[ON]", \
      "color":"gray", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/set_return_to_last_grounded {enabled:1}"}, \
  ...
  execute if score #damageMode av_cfg matches 1 run tellraw @s [ \
    ...
    { \
      "text":"[Absolute]", \
      "color":"gray", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/set_damage_mode {mode:2}"}, \
    ...
    { \
      "text":"[Normal]", \
      "color":"gray", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/set_damage_mode {mode:0}"}, \
  ...
  execute if score #damageMode av_cfg matches 2 run tellraw @s [ \
    ...
    { \
      "text":"[PreventDeath]", \
      "color":"gray", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/set_damage_mode {mode:1}"}, \
      "hover_event":{"action":"show_text","value":{"text":"Clamp to half a heart","color":"green"}} \
    }, \
    {"text":" ","color":"gray"}, \
    { \
  ...
  execute if score #damageMode av_cfg matches 2 run tellraw @s [ \
    ...
    { \
      "text":"[-1]", \
      "color":"red", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/adjust_absolute_damage {delta:-1}"}, \
  ...
  tellraw @s [ \
    ...
    { \
      "text":"[-10]", \
      "color":"red", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/remove_height_overworld {value:10}"}, \
    ...
    { \
      "text":"[-5]", \
      "color":"red", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/remove_height_overworld {value:5}"}, \
    ...
    { \
      "text":"[-1]", \
      "color":"red", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/remove_height_overworld {value:1}"}, \
    ...
    { \
      "text":"[+1]", \
      "color":"green", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/add_height_overworld {value:1}"}, \
    ...
    { \
      "text":"[+5]", \
      "color":"green", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/add_height_overworld {value:5}"}, \
    ...
    { \
      "text":"[+10]", \
      "color":"green", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/add_height_overworld {value:10}"}, \
  ...
  tellraw @s [ \
    ...
    { \
      "text":"[-10]", \
      "color":"red", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/remove_height_nether {value:10}"}, \
    ...
    { \
      "text":"[-5]", \
      "color":"red", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/remove_height_nether {value:5}"}, \
    ...
    { \
      "text":"[-1]", \
      "color":"red", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/remove_height_nether {value:1}"}, \
    ...
    { \
      "text":"[+1]", \
      "color":"green", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/add_height_nether {value:1}"}, \
    ...
    { \
      "text":"[+5]", \
      "color":"green", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/add_height_nether {value:5}"}, \
    ...
    { \
      "text":"[+10]", \
      "color":"green", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/add_height_nether {value:10}"}, \
  ...
  tellraw @s [ \
    ...
    { \
      "text":"[-10]", \
      "color":"red", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/remove_height_end {value:10}"}, \
    ...
    { \
      "text":"[-5]", \
      "color":"red", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/remove_height_end {value:5}"}, \
    ...
    { \
      "text":"[-1]", \
      "color":"red", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/remove_height_end {value:1}"}, \
    ...
    { \
      "text":"[+1]", \
      "color":"green", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/add_height_end {value:1}"}, \
    ...
    { \
      "text":"[+5]", \
      "color":"green", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/add_height_end {value:5}"}, \
    ...
    { \
      "text":"[+10]", \
      "color":"green", \
      "click_event":{"action":"run_command","command":"/function aether_void:internal/config/add_height_end {value:10}"}, \
