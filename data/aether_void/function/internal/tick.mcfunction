# Config trigger
# triggers
scoreboard players enable @a aether_void_config
execute as @a[scores={aether_void_config=1..}] at @s run function aether_void:_config
execute as @a[scores={aether_void_config=1..}] run scoreboard players set @s aether_void_config 0
