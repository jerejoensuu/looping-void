# Read marker X and Z
execute store result score @s lv_x run data get entity @e[type=minecraft:marker,tag=lv_temp,limit=1] Pos[0] 1
execute store result score @s lv_z run data get entity @e[type=minecraft:marker,tag=lv_temp,limit=1] Pos[2] 1
